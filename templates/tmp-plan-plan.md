# Filename: Mesh/Types/Plans/(Plan) XXX [Name].md

/* XXX is a 3-digit number. Get it with: flint helper type newnumber Plan */
...
/* State Transitions - update tags when state changes:
   ...
   - approved → spent: Replace #plan/approved with #plan/spent
*/
