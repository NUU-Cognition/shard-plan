...
This workflow belongs to the Plan shard. Ensure you have @init-plan.md in context before continuing.
...
- Create plan artifact using @tmp-plan-plan with:
  - Get the next plan number with `flint helper type newnumber Plan`
